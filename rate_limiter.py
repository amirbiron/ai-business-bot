...
_WINDOWS = [
    (
        60,
        RATE_LIMIT_PER_MINUTE,
        "שלחתם מספר רב של הודעות ברגעים האחרונים.\n"
        "אנא המתינו דקה ונשמח להמשיך לעזור!",
    ),
    (
        3600,
        RATE_LIMIT_PER_HOUR,
        "נראה שאתם פעילים מאוד היום!\n"
        "כדי שנוכל לתת שירות איכותי לכולם, ההודעות מוגבלות.\n"
        "נסו שוב בעוד מספר דקות.",
    ),
    (
        86400,
        RATE_LIMIT_PER_DAY,
        "הגעתם למגבלת ההודעות היומית.\n"
        "אם יש עניין דחוף, לחצו על *👤 דברו עם נציג* "
        "ונציג אנושי ישמח לעזור!",
    ),
]
