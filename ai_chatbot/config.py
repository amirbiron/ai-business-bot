...
# ─── Paths ───────────────────────────────────────────────────────────────────
# Keep default data/ paths at repo root for backwards compatibility.
...
2. אם ההקשר לא מכיל מספיק מידע כדי לענות, אמור: "אין לי את המידע הזה כרגע. תנו לי להעביר אתכם לנציג אנושי שיוכל לעזור."
...
FALLBACK_RESPONSE = (
    ...
    "תנו לי לחבר אתכם עם נציג אנושי שיוכל לעזור לכם טוב יותר. "
